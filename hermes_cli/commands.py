...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("reload", "Hot-reload config, souls, extensions, and env without restart", "Configuration",
               aliases=("rl",), args_hint="[env|config|souls|bindings|extensions|all]"),
